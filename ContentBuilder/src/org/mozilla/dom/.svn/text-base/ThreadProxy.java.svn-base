...
public abstract class ThreadProxy
{
    ...
    public abstract void syncExec(Runnable task);
    public abstract <V> V syncExec(Callable<V> task);
    
    private static ThreadProxy tp = new DefaultThreadProxy();
    public static ThreadProxy getSingleton() { return tp; }
    public static void setSingleton(ThreadProxy t) { tp = t; }
